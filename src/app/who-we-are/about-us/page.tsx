...
export default function AboutUsPage() {
  ...
  const ourStoryContent = `Nala center for Innovative Thinking is an independent, nonpartisan policy and research lab driving evidence-based solutions to the world's most complex and consequential challenges. We work at the intersection of research, policy, and practice - where analytical rigor meets the urgency of real-world decision-making.

Our research spans five core focus areas - Peace & Security; Democracy, Governance & Civic Innovation; Economic Systems, Equity & Inclusive Development; Sustainable Energy & Climate Resilience; and Migration, Mobility & Human Rights - areas we treat not as separate disciplines but as interconnected forces that together determine how societies are built, governed, and sustained. We produce high-quality, policy-relevant research through an interdisciplinary methodology drawing from political science, sociology, economics, law, and environmental studies, translating that knowledge into action through publications, direct policy engagement, training and capacity building programmes, and strategic convenings that unite researchers, civil society, and decision-makers around shared challenges. 

A defining feature of nala center is our investment in the next generation through our Associate Fellows programme, structured mentorship, and co-research opportunities, we cultivate diverse scholars and policy thinkers equipped to tackle tomorrow's challenges with fresh perspective and rigorous method. Through every publication, partnership, and platform, nala center for Innovative Thinking is shaping the intellectual foundations for a more just, peaceful, and sustainable world.`
